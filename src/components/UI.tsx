  ...
  return (
    <div className="card overflow-hidden animate-fadeUp">
      <div className="flex items-center justify-between px-3 sm:px-4 md:px-5 py-3 md:py-4"
        ...
        <div>
          <h3 className="font-bold text-[14px] md:text-[16px]" style={{ color: 'var(--ink)' }}>{title}</h3>
          {description && (
    ...
    <div className="flex items-center justify-between px-3 sm:px-5 py-3"
      ...
      <div className="flex items-center gap-[6px]">
        <button type="button" onClick={() => onPage(Math.max(0, offset - limit))} disabled={offset === 0}
                className="h-[28px] sm:h-[30px] px-2 sm:px-3 rounded-[7px] text-[12px] sm:text-[13px] font-semibold disabled:opacity-40 disabled:cursor-not-allowed"
